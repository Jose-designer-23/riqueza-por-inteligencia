...
const Inicio = ({musicaFondoRef}) => {
  ...
  return (
    <div className="caja fondo_pregunta estructura_pregunta flex flex-col items-center justify-center text-center">
      <h1 className="text-4xl font-bold mb-4">Riqueza por Inteligencia</h1>
      <p className="text-lg mb-6 text-justify font-semibold">Serás capaz de llegar a la pregunta 15 y llevarte un millón de euros? El juego consta de 15 preguntas, 
        ...
        <p className="font-semibold p-2 text-justify text-lg">En el juego hay 2 comodines que podrás usar una vez por partida.</p>
        <p className="p-2 text-justify text-lg"><span className="font-bold">50%:</span> Este comodín te eliminará 2 respuestas incorrectas de la pregunta. </p>
        <p className="p-2 text-justify text-lg"><span className="font-bold">Aleatorio:</span> Este comodín eliminara al azar entre 1 y 3 respuestas incorrectas. </p>
